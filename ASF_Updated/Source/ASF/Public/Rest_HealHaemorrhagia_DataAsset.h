...
#include "Rest_HealHaemorrhagia_DataAsset.generated.h"

class ASquad;

UCLASS(Blueprintable)
class ASF_API URest_HealHaemorrhagia_DataAsset : public UPrimaryDataAsset, public IRestModifier_Interface {
    GENERATED_BODY()
public:
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FText RestDescription;
    
    URest_HealHaemorrhagia_DataAsset();
