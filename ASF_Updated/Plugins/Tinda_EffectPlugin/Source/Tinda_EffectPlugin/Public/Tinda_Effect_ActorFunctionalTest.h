...
#include "Tinda_Effect_ActorFunctionalTest.generated.h"

class UTinda_EffectHandlerComponent;

UCLASS(Blueprintable)
class TINDA_EFFECTPLUGIN_API ATinda_Effect_ActorFunctionalTest : public AActor, public ITinda_GameplayTagAssetInterface {
    GENERATED_BODY()
public:
    ...
    ATinda_Effect_ActorFunctionalTest(const FObjectInitializer& ObjectInitializer);
